...
const SvgFoodSweet2 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 72 72" width="1em" height="1em" {...props}>
    ...
    <g
      ...
      strokeWidth={1.939}
    >
      <path d="M64 35.875a9.632 9.632 0 00-1.558-5.262 9.643 9.643 0 00-.574-5.453 9.64 9.64 0 00-3.452-4.265 9.631 9.631 0 00-2.618-4.818 9.633 9.633 0 00-4.82-2.62 9.645 9.645 0 00-4.262-3.45 9.65 9.65 0 00-5.457-.575 9.648 9.648 0 00-5.26-1.556c-1.94 0-3.744.576-5.26 1.557a9.646 9.646 0 00-5.455.574 9.642 9.642 0 00-4.263 3.453 9.648 9.648 0 00-7.438 7.439 9.647 9.647 0 00-4.025 9.72A9.649 9.649 0 008 35.877c0 1.941.577 3.746 1.559 5.262a9.66 9.66 0 004.028 9.718 9.648 9.648 0 007.438 7.436 9.659 9.659 0 009.718 4.025 9.65 9.65 0 005.26 1.557c1.94 0 3.744-.576 5.26-1.557a9.652 9.652 0 009.718-4.027 9.634 9.634 0 004.819-2.617 9.63 9.63 0 002.619-4.822 9.65 9.65 0 003.45-4.262 9.649 9.649 0 00.575-5.457A9.657 9.657 0 0064 35.875z" />
