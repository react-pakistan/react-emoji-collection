...
import { EMOJI_LIST } from './face-neutral-skeptical';
...
export const FaceNeutralSkeptical = () : ReactElement => (
  <EmojiWrapper>
    {emojis}
  </EmojiWrapper>
);
...
export default {
  title: 'PeopleBody|FaceNeutralSkeptical',

  parameters: {
    component: FaceNeutralSkeptical,
  },
};
