...
const SvgAlphanum16 = (props: IEmojiProps) => (
  <svg viewBox="0 0 72 72" width="1em" height="1em" {...props}>
    ...
    <g fill="none" stroke="#000" strokeMiterlimit={10} strokeWidth={2}>
      ...
      <path
        ...
        d="M37.486 32.47h-4.572v8h4.572M32.914 36.47h3.429M23 40.47v-8l5.714 8v-8M50 32.47l-2.286 8-2.285-8-2.286 8-2.286-8"
      />
    </g>
  </svg>
);

export default SvgAlphanum16;
