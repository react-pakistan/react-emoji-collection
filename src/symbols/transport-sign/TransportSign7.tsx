...
const SvgTransportSign7 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 72 72" width="1em" height="1em" {...props}>
    ...
    <path
      fill="#FFF"
      d="M40.416 37.653s-1.11-.284-.716.9l-3.618-1.993 1.04-1.18 3.294 2.273zM30.457 37.653s1.109-.284.716.9l3.618-1.993-1.04-1.18-3.294 2.273z"
    />
    <path
      fill="none"
      stroke="#FFF"
      ...
      strokeMiterlimit={10}
      strokeWidth={3}
      d="M46.2 39.6c-5.3-4.6-10.7-4.233-10.7-4.233S29.9 35 24.6 39.6"
    />
    <path fill="#FFF" d="M31 39l2-4 5.889-.03L40 39h-9" />
    <path
      fill="#FFF"
      d="M39 38.6l5.6 11.2s0 1.4-1.4 1.4-5.6-4.2-5.6-4.2h-2.8 1.4-2.8s-4.2 4.2-5.6 4.2c-1.4 0-1.4-1.4-1.4-1.4L32 38.6"
    />
