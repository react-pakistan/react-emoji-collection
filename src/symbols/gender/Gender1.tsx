...
const SvgGender1 = (props: IEmojiProps) => (
  <svg viewBox="0 0 72 72" width="1em" height="1em" {...props}>
    ...
    >
      ...
      <path
        strokeMiterlimit={10}
        d="M57.44 11.95H45.05l-3.77 3.768h9.695l-8.269 8.263m2.692 2.689l8.27-8.259v9.686l3.77-3.768v-12.38M14.56 11.92v8.147l3.37 3.368V17.98l4.502 4.498m2.697 2.695l1.564 1.563m2.691-2.69l-1.555-1.554m-2.696-2.694l-4.508-4.51h6.128l-3.37-3.368h-8.824"
      />
