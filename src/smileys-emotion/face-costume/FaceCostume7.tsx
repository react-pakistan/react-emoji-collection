...
const SvgFaceCostume7 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 72 72" width="1em" height="1em" {...props}>
    ...
    />
    <circle cx={44.835} cy={29.003} fill="#FFF" r={2.834} />
    <circle cx={27.334} cy={29.002} fill="#FFF" r={2.834} />
    <path
      fill="#FFF"
      d="M44.5 47.5h-17c-2.2 0-4-1.8-4-4s1.8-4 4-4h17c2.2 0 4 1.8 4 4s-1.8 4-4 4z"
    />
    <g fill="none" stroke="#000" strokeMiterlimit={2} strokeWidth={2}>
      <path
        strokeLinecap="round"
...
export default SvgFaceCostume7;
