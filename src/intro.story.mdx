...
<div>
  ...
  <right style={{ paddingLeft: '10px' }}>
    <a href="https://www.npmjs.com/package/@react-pakistan/react-emoji-collection" target="_blank">
      <img
...
Import SVG Reactified Emoji you want into your component

`import { SvgHands1 } from ‘@react-pakistan/util-function’;`
