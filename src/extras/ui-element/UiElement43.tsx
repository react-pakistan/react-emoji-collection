...
const SvgUiElement43 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 72 72" width="1em" height="1em" {...props}>
    ...
    <path
      ...
      strokeMiterlimit={10}
      strokeWidth={2}
      d="M60.136 52.663c1.116 2.95 3.99 6.701 6.864 8.617-6 0-10.244-1.752-13.398-6.09"
    />
    <path
      fill="none"
      stroke="#000"
