...
const SvgObjects14 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 72 72" width="1em" height="1em" {...props}>
    <path
      fill="#3F3F3F"
      fillRule="evenodd"
      d="M49.5 21H42v2.5h7.5v4C49.5 30 44 41 44 41l3 6s5-15.5 5-19.5V21h-2.5z"
      clipRule="evenodd"
    />
    <path
      fill="#d0cfce"
      d="M18 27.5V21h4v4c0 2.5 4 6 4 6l-3 16s-5-15.5-5-19.5z"
    />
    <path
      fill="#d0cfce"
      fillRule="evenodd"
      d="M27.11 17c.635-2.838 3.926-5 7.89-5 3.964 0 7.255 2.162 7.89 5H43l5 33.5-3 9.5H25l-3-9.5L27 17h.11z"
      clipRule="evenodd"
    />
    <path
      fill="#D0CFCE"
      fillRule="evenodd"
      d="M32.667 60H30l-2-9.5L31.333 17H34l-3.333 33.5 2 9.5z"
      clipRule="evenodd"
    />
    <path
      fill="#3F3F3F"
      fillRule="evenodd"
      d="M47.776 49H22.224L22 50.5l3 9.5h20l3-9.5-.224-1.5z"
      clipRule="evenodd"
    />
    <circle
      cx={35.5}
      ...
      strokeWidth={2}
    />
    <path fill="#3F3F3F" d="M33 8h4v4h-4z" />
    <g>
      <path
        fill="none"
        stroke="#000"
