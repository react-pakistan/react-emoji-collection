...
const SvgTechnology16 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 72 72" width="1em" height="1em" {...props}>
    <circle cx={36} cy={32} r={5} fill="#3F3F3F" />
    <path fill="#D0CFCE" d="M34 62h4l-2-25z" />
    <path fill="#9B9B9A" d="M36 37l2 25h-2.02L36 37" />
    <g
      fill="none"
      stroke="#000"
      strokeLinecap="round"
    ...
    >
      ...
      <path d="M40.895 40.715A9.992 9.992 0 0046 32c0-5.523-4.477-10-10-10s-10 4.477-10 10c0 3.743 2.06 7 5.105 8.715" />
    </g>
  </svg>
);

export default SvgTechnology16;
