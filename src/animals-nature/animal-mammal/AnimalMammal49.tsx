...
const SvgAnimalMammal49 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 72 72" width="1em" height="1em" {...props}>
    <path
      fill="#A57939"
      d="M22.754 11.085l1.667 7.167-5.333 5.333-8.334 14.334 1 4.667 2.167 1.333 4-.167 3.5-3.333 6.833-1.833s1.334 1.5 2.167 3 3.667 4.166 3.667 4.166l.5 6-1.833 6.167-2 2.833s22 9.5 33.166-7l-.5-6-1.833-5-3.333-5.167-1-1.5-.167-5.166-2.833-5.334-5-3-2.667-4.5-5.167-4.166-6.5-1.5-5.666 1-4.167-2.167-2.334-.167z"
    />
    <path
      fill="#6A462F"
    ...
    <g>
      ...
      <path
        ...
        strokeMiterlimit={10}
        strokeWidth={2}
        d="M33.946 29.955c.55 8.355-9.322 9.703-11.954 10.335-.332.08-.632.25-.873.492l-2.223 2.222c-.35.35-.824.546-1.318.546h-3.512a2.795 2.795 0 01-2.651-1.911l-.531-1.593a2.795 2.795 0 01.255-2.322l8.786-14.643 4.724-4.724-2.116-6.906s7.803-.698 8.414 5.331c0 0 16.928 2.442 10.553 19.383 0 0-1.625 5.949 2.375 11.185M29.667 13.106s22.244-4.02 19.958 19.959"
      />
      <path
        fill="none"
        stroke="#000"
...
export default SvgAnimalMammal49;
