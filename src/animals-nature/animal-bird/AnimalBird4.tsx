...
const SvgAnimalBird4 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 72 72" width="1em" height="1em" {...props}>
    ...
    <g>
      ...
      <path
        fill="#1e50a0"
        d="M34.892 22.601a3.136 3.136 0 013.075 2.196c1.304 3.145-.204 10.255.348 13.615.43 2.607 4.276 7.02 4.283 9.663.011 4.83-3.533 7.925-6.598 7.883-4.215-.057-6.547-5.314-6.598-7.883-.065-3.294 3.4-7.173 4.283-9.663.837-2.361 1.576-9.115.076-10.502-.631-.583-4.359-.588-4.359-.588s3.185-4.72 5.49-4.72z"
      />
    ...
    >
      ...
      <path d="M34.892 22.601a3.136 3.136 0 013.075 2.196c1.304 3.145-.204 10.255.348 13.615.43 2.607 4.276 7.02 4.283 9.663.011 4.83-3.533 7.925-6.598 7.883-4.215-.057-6.547-5.314-6.598-7.883-.065-3.294 3.4-7.173 4.283-9.663.837-2.361 1.576-9.016.768-9.992-.548-.662-5.05-1.098-5.05-1.098s3.184-4.72 5.49-4.72z" />
      <path d="M33.044 54.957v5.635l-2.217.739M35.261 60.592h-2.217M38.956 55.081v5.511l-2.217.739M41.173 60.592h-2.217" />
    </g>
  </svg>
);

export default SvgAnimalBird4;
