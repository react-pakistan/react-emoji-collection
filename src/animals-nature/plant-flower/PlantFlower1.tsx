...
const SvgPlantFlower1 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 72 72" width="1em" height="1em" {...props}>
    ...
    <g fill="none" stroke="#000" strokeLinejoin="round" strokeWidth={2}>
      <path
        strokeLinecap="round"
        d="M53.197 18.174c-3.76-3.76-11.587-2.037-17.627 3.812-5.938-5.34-13.335-6.805-16.957-3.183-3.626 3.626-2.154 11.036 3.202 16.978-5.356 5.94-6.828 13.351-3.202 16.977 3.622 3.622 11.02 2.158 16.957-3.183 6.04 5.849 13.867 7.571 17.627 3.812 3.755-3.755 2.04-11.569-3.792-17.606 5.832-6.038 7.547-13.851 3.792-17.607zM58.547 42.897A8.312 8.312 0 0062 36.535c0-2.575-1.485-4.929-3.947-6.745M28.391 57.71c1.857 2.738 4.342 4.411 7.075 4.411a8.306 8.306 0 006.35-3.436M13.125 30.343a8.207 8.207 0 00-3.246 6.192 7.855 7.855 0 002.566 5.57M42.077 13.77c-1.797-2.356-4.1-3.77-6.611-3.77a8.302 8.302 0 00-6.349 3.435"
      />
...
export default SvgPlantFlower1;
